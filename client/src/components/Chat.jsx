        ...
        socket.on("messageUpdated", (updatedMessage) => {
            setMessages((prevMessages) => {
                const updatedMessages = prevMessages.map((msg) =>
                    (msg._id === updatedMessage._id || msg.tempId === updatedMessage.tempId)
                        ? updatedMessage
                        : msg
                );
                saveMessagesToLocalStorage(updatedMessages);
            ...
            <div className="flex items-center">
                {isSelecting && (
                    <input
                        type="checkbox"
                        checked={isSelected}
                        onChange={() => onSelect(message._id || message.tempId)}
                        className="mr-2"
                    />
                )}
                <div
                ...
                >
                    ...
                    {isSender && (
                        <div className="flex justify-end mt-1">
                            {message.seenBy?.includes(message.receiver) ? (
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                >
                                    <path
                                        ...
                                        strokeWidth="2"
                                        d="M5 13l4 4L19 7M5 7l4 4L19 13"
                                    />
                                </svg>
                            ) : (
                                <svg
