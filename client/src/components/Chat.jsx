                        ...
                        <>
                            <div className="p-4 border-b flex justify-between items-center bg-gray-800">
                                ...
                                <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row items-center space-x-2">
                                    ...
                                    {isInCall && (
                                        <>
                                            <span className="text-green-400 font-semibold">Call Started</span>
                                            <button
...
const ChatMessage = ({
    ...
    console.log(`Rendering message for ${isSender ? "sender" : "receiver"}:`, message);
        ...
        >
            ...
            <div
                ...
                onClick={() => {
                    ...
                    else if (isPinMode && message._id) togglePinSelection();
                }}
            >
                <div
                    style={{
                ...
                {isPinMode && message._id && (
                    <div
                        className={`absolute top-1/2 ${isSender ? "-left-8" : "-right-8"} transform -translate-y-1/2 w-5 h-5 rounded-full border-2 border-yellow-500 flex items-center justify-center ${
                            isPinSelected ? "bg-yellow-500" : "bg-transparent"
                        }`}
                        onClick={(e) => {
                            e.stopPropagation();
                            togglePinSelection();
