...
// VideoCall Component (already provided, but we'll update its usage)
...
export default function Chat() {
  ...
  // PeerJS Setup with Default Cloud Server
  useEffect(() => {
  ...
  // Listen for Incoming Video Call Notifications via Socket.IO
  useEffect(() => {
            ...
            <>
              ...
              {isVideoCallVisible && (
                <VideoCall
                  ...
                  socket={socket} // Pass the socket to VideoCall
                />
              )}
