...
const Login = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            if (res.data.success) {
                ...
                localStorage.setItem("email", input.email);  // Store the login email
                    ...
                    <form onSubmit={ submitHandler }>
                        ...
                        >
                            ...
                            <Input
                                ...
                                onChange={ changeEventHandler }
                            />
                            <p className='text-gray-500 mt-3'>{ t('PasswordRequirement') }</p>
                        </motion.div>
    ...
    <Link to="/forget-password" className="text-blue-500 mx-1">
        { t('ForgotPassword') }
    </Link>
</p>
