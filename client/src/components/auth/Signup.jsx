...
const Signup = () => {
    ...
    const [errors, setErrors] = useState({
        ...
        phoneNumber: '',
        password: '',
        confirmPassword: '', // Added confirmPassword error
        role: '',
    });
    const [isValidating, setIsValidating] = useState(false);
    const [validationResult, setValidationResult] = useState("");
    ...
    const submitHandler = async (e) => {
        ...
        if (!/^\d{10,11}$/.test(input.phoneNumber)) newErrors.phoneNumber = "Must be 10 to 11 digits long";
        if (input.password.length < 8) newErrors.password = "At least 8 characters required";
        ...
        try {
            ...
            Object.keys(input).forEach((key) => {
                if (key !== 'confirmPassword') { // Exclude confirmPassword from formData
                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <motion.div className="mb-4" initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.4 }}>
                            ...
                            <Input
                                ...
                                value={input.fullname}
                                onChange={changeEventHandler}
                                className={`text-white bg-gray-800 border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md ${errors.fullname ? "border-red-500" : ""}`}
                            />
                        ...
                        <motion.div className="mb-4" initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.5 }}>
                            ...
                            <Input
                                ...
                                aria-invalid={errors.email ? "true" : "false"}
                                aria-describedby={errors.email ? "email-error" : undefined}
                                className={`text-white bg-gray-800 border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md ${errors.email ? "border-red-500 focus:ring-red-500" : ""}`}
                            />
                            {errors.email && <p id="email-error" className="text-red-400 text-sm mt-1">{errors.email}</p>}
                            {isValidating && <p className="text-blue-400 text-sm mt-1">Validating email...</p>}
                            {!errors.email && validationResult && <p className="text-green-400 text-sm mt-1">{validationResult}</p>}
                        </motion.div>
                        ...
                        <motion.div className="mb-4" initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ delay: 0.8 }}>
                            ...
                            <Input
                                ...
                                onChange={changeEventHandler}
                                className={`text-white bg-gray-800 border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md ${errors.confirmPassword ? "border-red-500" : ""}`}
                            />
